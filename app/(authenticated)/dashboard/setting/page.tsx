...
export default function SettingsPage() {
	...
	const [isDeleteUserAccountModalOpen, setIsDeleteUserAccountModalOpen] =
		useState(false);
				...
				return (
					<div className="space-y-6">
						...
						<div className="text-center">
							<p className="text-sm text-gray-500">
								To update your profile information, please visit your Google
								account settings.
							</p>
						</div>
						<div className="text-center">
						...
						<div className="space-y-4">
							<div className="bg-blue-50 p-4 rounded-lg">
								...
								<p className="text-sm text-sky-400 mt-1">
									Your account security, including two-factor authentication and
