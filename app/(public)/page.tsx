			...
			<header className="bg-gradient-to-br from-green-500 to-teal-500 text-white py-20 md:py-32">
				<div className="container mx-auto px-4 text-center">
					...
					<p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto opacity-90">
						Gain complete control and visibility over your demand and inventory
						levels to boost efficiency from anywhere, anytime.
					</p>
					<Link
						href="/pricing-plan"
				...
				<div className="container mx-auto px-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
							...
							<div className="mb-4 text-teal-500">
								...
								>
									...
									<path
										...
										strokeWidth="2"
										d="M9 17v2a2 2 0 002 2h2a2 2 0 002-2v-2m6 0H9m5 0a2 2 0 012-2V9a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm2-11V5a2 2 0 00-2-2H9a2 2 0 00-2 2v2h10z"
									/>
								</svg>
							</div>
							<h3 className="text-xl font-semibold mb-3 text-gray-800">
								Demand tracking with pre-orders
							</h3>
						...
						<div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300 border border-gray-100 flex flex-col items-center text-center">
							<div className="mb-4 text-teal-700">
								...
								>
									...
									<path
										...
										strokeLinejoin="round"
										strokeWidth="2"
										d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6m0 0a2 2 0 002 2h2a2 2 0 002-2m0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2"
									/>
								</svg>
							</div>
							<h3 className="text-xl font-semibold mb-3 text-gray-800">
							...
							<p className="text-gray-600">
								Generate insightful reports on sales, stock turnover, and
								inventory aging to make informed business decisions.
							</p>
						</div>
							...
							<div className="mb-4 text-teal-400">
								...
								>
									...
									<path
										...
										strokeLinejoin="round"
										strokeWidth="2"
										d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.592 1L21 12h-3m-4 0h-4m-7 0H3"
									/>
								</svg>
							</div>
							<h3 className="text-xl font-semibold mb-3 text-gray-800">
							...
							<div className="mb-4 text-orange-400">
								...
								>
									...
									<path
										...
										strokeLinejoin="round"
										strokeWidth="2"
										d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 012-2h2a2 2 0 012 2v1m-4 0h-2m6 0h-2"
									/>
								</svg>
							</div>
							<h3 className="text-xl font-semibold mb-3 text-gray-800">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						...
						<div className="bg-white p-8 rounded-lg shadow-lg flex flex-col items-center text-center">
							...
							<p className="text-lg italic mb-4 text-gray-700">
								...
								ones, it is a game-changer. Now we can see which items are
