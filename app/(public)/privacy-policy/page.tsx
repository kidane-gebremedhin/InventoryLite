export default function TermsAndConditionsPage() {
  return (
    <div className="container mx-auto p-8 max-w-4xl bg-white shadow-lg rounded-lg my-12">
      <h1 className="text-center font-bold text-lg">Summary of our Privacy Policy</h1>
      It covers every Zoho website that links here, and all of the products and services contained on those websites. The detailed policy follows the same structure as this summary and constitutes the actual legal document.
      ...
      <h2 className="font-bold text-md py-2">Part I – Information Zoho collects and controls</h2>
      ...
      <h2 className="font-bold text-md py-2">What we do with your information</h2>
      ...
      <h2 className="font-bold text-md py-2">Part II – Information that Zoho processes on your behalf</h2>
      ...
      This Privacy Policy statement is made by the Zoho Group consisting of all the entities listed here (collectively, "Zoho", "we", "us" or "our").
      ...
      <h2 className="text-center font-bold text-md py-2">Part I – Information Zoho collects and controls</h2>
      ...
      ii. Referrals : If someone has referred any of our products or services to you through any of our referral programs, that person may have provided us your name, email address and other personal information. You may contact us at privacy@zohocorp.com to request that we remove your information from our database. If you provide us information about another person, or if another person gives us your information, we will only use that information for the specific reason for which it was provided to us.
      ...
      <h2 className="font-bold text-md py-2">Legal bases for collecting and using information</h2>
      Legal processing bases applicable to Zoho : If you are an individual from the European Economic Area (EEA), our legal basis for information collection and use depends on the personal information concerned and the context in which we collect it. Most of our information collection and processing activities are typically based on (i) contractual necessity, (ii) one or more legitimate interests of Zoho or a third party that are not overridden by your data protection interests, or (iii) your consent. Sometimes, we may be legally required to collect your information, or may need your personal information to protect your vital interests or those of another person.
      ...
      <h2 className="font-bold text-md py-2">Who we share your information with</h2>
      All Zoho group entities listed here have access to the information covered in Part I. We do not sell any personal information. We share your information only in the ways that are described in this Privacy Policy, and only with parties who adopt appropriate confidentiality and security measures.
      ...
      <h2 className="font-bold text-md py-2">Your rights with respect to information we hold about you as a controller</h2>
      ...
      <h2 className="text-center font-bold text-md py-2">Part II – Information that Zoho processes on your behalf</h2>
      ...
      <h2 className="font-bold text-md py-2">Children’s personal information</h2>
      Our products and services are not directed to individuals under 16. Zoho does not knowingly collect personal information from children who are under 16 years of age for its own purposes. If we become aware that a child under 16 has provided us with personal information, we will take steps to delete such information. If you believe that a child under 16 years has provided personal information to us, please write to privacy@zohocorp.com with the details, and we will take the necessary steps to delete the information we hold about that child. However, using our products, you can collect information about individuals who may be children. If you process information relating to children, you acknowledge and agree that you will be responsible for complying with the applicable laws and regulations related to protection of such personal information.

      <h2 className="font-bold text-md py-2">How secure is your information</h2>
      At Zoho, we take data security very seriously. That's why we have gotten certified for industry standards mentioned here. We have taken steps to implement appropriate administrative, technical & physical safeguards to prevent unauthorized access, use, modification, disclosure or destruction of the information you entrust to us. If you have any concerns regarding the security of your data, we encourage you to check our Security Policy or write to us at security@zohocorp.com with any questions.

      <h2 className="font-bold text-md py-2">Data Protection Officer</h2>
      We have appointed a Data Protection Officer to oversee our management of your personal information in accordance with this Privacy Policy. If you have any questions or concerns about our privacy practices with respect to your personal information, you can reach out to our Data Protection Officer by sending an email to dpo@zohocorp.com or by writing to: Data Protection Officer, Zoho Corporation BV, Beneluxlaan 4B, 3527 HT Utrecht, The Netherlands.

      <h2 className="font-bold text-md py-2">Locations and international transfers</h2>
      We share your personal information and service data within the Zoho Group and with third parties engaged by Zoho Group for the purposes described above. By accessing or using our products and services or otherwise providing personal information or service data to us, you understand that the processing, transfer, and storage of your personal information or Service Data within the United States of America, the European Economic Area (EEA) and other countries where Zoho operates. Such transfers are subject to appropriate data protection agreements such as a group company agreement that is based on EU Commission’s Model Contractual Clauses for data processing activities to which GDPR applies. You can write to legal@zohocorp.com for obtaining a copy of the agreements on the basis of which we transfer your data within Zoho Group and with the third parties engaged by us.

      <h2 className="font-bold text-md py-2">Data processing addendum</h2>
      To enable you to be compliant with your data protection obligations , we are prepared to sign an appropriate Data Processing Addendum (DPA). You can request a DPA from Zoho by completing this form . Once we get your request, we'll forward the DPA to you for your signature.

      <h2 className="font-bold text-md py-2">Automation and Artificial Intelligence</h2>
      ...
      <h2 className="font-bold text-md py-2">Disclosures in compliance with legal obligations</h2>
