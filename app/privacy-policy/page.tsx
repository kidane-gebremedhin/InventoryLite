// app/terms/page.tsx
// This file will render the Terms and Conditions for your ${APP_NAME} Inventory Management System.

'use client'; // This component will run on the client-side to render Markdown.

import { APP_NAME, CONTACT_EMAIL } from '@/lib/Constants';
import React from 'react';
import ReactMarkdown from 'react-markdown';

// The Markdown content for your Terms and Conditions.
// This is imported from the Canvas document "Inventory Management System - Terms and Conditions".
const termsAndConditionsMarkdown = `
Summary of our Privacy Policy
It covers every ${APP_NAME} website that links here, and all of the products and services contained on those websites. The detailed policy follows the same structure as this summary and constitutes the actual legal document.

Our privacy commitment: ${APP_NAME} has never sold your information to someone else for advertising, or made money by showing you other people's ads, and we never will. This has been our approach for almost 25 years, and we remain committed to it. This policy tells you what information we collect from you, what we do with it, who can access it, and what you can do about it.

Last updated on: 5th June 2023.

Part I – Information ${APP_NAME} collects and controls
...
The European Economic Area (EEA) provides certain rights to data subjects (including access, rectification, erasure, restriction of processing, data portability, and the right to object and to complain). ${APP_NAME} undertakes to provide you the same rights no matter where you choose to live.
...
Part II – Information that ${APP_NAME} processes on your behalf
If you handle other people's data using ${APP_NAME} apps, such as information about your customers or employees, you are entrusting that data to us for processing. If you use a ${APP_NAME} mobile app and give the app access to your contacts and photo library, you are entrusting data to us. The data you entrust to us for processing is called service data.
...
We hold the data in your account as long as you choose to use ${APP_NAME} Services. After you terminate your account, your data will be automatically deleted from our active database within 6 months and from our backups within 3 months after that.
...
Privacy Policy
This Privacy Policy statement is made by the ${APP_NAME} Group consisting of all the entities listed here (collectively, "${APP_NAME}", "we", "us" or "our").

${APP_NAME}’s Privacy Commitment
${APP_NAME} has worried about customer and user privacy for almost 25 years, long before it became fashionable, politically correct, or legally binding to take such a position. We ask for only the least amount of information necessary, gathering only what we believe is essential for doing business, or for the specific transaction at hand. We let customers know the information we have on them and allow them to opt out of specific engagements. But, by far, our biggest commitment is that we do not make a single dollar from advertising revenue—never have, never will—even from the free editions of our products. This means we avoid the fundamental conflict of interest between gathering customer information and fueling advertising revenue, and the unavoidable compromises in customer privacy that it brings.
...
This Privacy Policy applies to all ${APP_NAME} websites that link to it. It also applies to the products and services provided by ${APP_NAME} through these websites, our mobile applications, and applications posted by ${APP_NAME} on ${APP_NAME}’s online marketplace and in other third-party online marketplaces. This Privacy Policy does not apply to any of our websites, products or services that have a separate privacy policy.

This Privacy Policy is divided into three parts:

Part I – Information ${APP_NAME} collects and controls
This part deals with how ${APP_NAME} collects and uses information about website visitors, potential customers, users of ${APP_NAME}'s products and services, and others who contact ${APP_NAME} through forms or email addresses published on or linked to our websites.

Part II – Information that ${APP_NAME} processes on your behalf
This part deals with how ${APP_NAME} handles data that you entrust to ${APP_NAME} when you use our products and services, or when you share any personal or confidential information with us while requesting customer support.

Part III – General
This part deals with topics that are relevant to both Parts I and II, and other general topics such as ${APP_NAME}'s security commitments and how we will inform you when we change this Privacy Policy.

Part I – Information ${APP_NAME} collects and controls
What information ${APP_NAME} collects
We collect information about you only if we need the information for some legitimate purpose. ${APP_NAME} will have information about you only if (a) you have provided the information yourself, (b) ${APP_NAME} has automatically collected the information, or (c) ${APP_NAME} has obtained the information from a third party. Below we describe the various scenarios that fall under each of those three categories and the information collected in each one.
...
v. Interactions with ${APP_NAME} : We may record, analyze and use your interactions with us, including email, telephone, and chat conversations with our sales and customer support professionals, for improving our interactions with you and other customers.
...
In addition to the purposes mentioned above, we may use your information for the following purposes:
 ...
 To detect and prevent fraudulent transactions and other illegal activities, to report spam, and to protect the rights and interests of ${APP_NAME}, ${APP_NAME}’s users, third parties and the public;
...
Legal processing bases applicable to ${APP_NAME} : If you are an individual from the European Economic Area (EEA), our legal basis for information collection and use depends on the personal information concerned and the context in which we collect it. Most of our information collection and processing activities are typically based on (i) contractual necessity, (ii) one or more legitimate interests of ${APP_NAME} or a third party that are not overridden by your data protection interests, or (iii) your consent. Sometimes, we may be legally required to collect your information, or may need your personal information to protect your vital interests or those of another person.
...
All ${APP_NAME} group entities listed here have access to the information covered in Part I. We do not sell any personal information. We share your information only in the ways that are described in this Privacy Policy, and only with parties who adopt appropriate confidentiality and security measures.

Employees and independent contractors : Employees and independent contractors of relevant ${APP_NAME} group entities have access to the information covered in Part I on a need-to-know basis. We require all employees and independent contractors of ${APP_NAME} group entities to follow this Privacy Policy for personal information that we share with them.
...
Domain registrars : When you register a domain through ${APP_NAME} from domain name registrars, we share your name and contact information such as your physical address, email address and phone number with them as per the ICANN domain registration rules.
...
Marketplace application developers : When you install or purchase any application developed using ${APP_NAME}'s APIs that is posted on ${APP_NAME}’s online marketplace, your name and email address will be shared with the developer of the application, so they may engage with you directly as the provider of that application or service. ${APP_NAME} does not control the use of your personal information by the developers, which will be based on their own privacy policies.
...
If you are in the European Economic Area (EEA), you have the following rights with respect to information that ${APP_NAME} holds about you. ${APP_NAME} undertakes to provide you the same rights no matter where you choose to live.
...
Part II – Information that ${APP_NAME} processes on your behalf
Information entrusted to ${APP_NAME} and purpose

Information provided in connection with services : You may entrust information that you or your organization (“you”) control, to ${APP_NAME} in connection with use of our services or for requesting technical support for our products. This includes information regarding your customers and your employees (if you are a controller) or data that you hold and use on behalf of another person for a specific purpose, such as a customer to whom you provide services (if you are a processor). The data may either be stored on our servers when you use our services, or transferred or shared to us as part of a request for technical support or other services.
...
(All the information entrusted to ${APP_NAME} is collectively termed “service data”)
...
${APP_NAME} group and third party sub-processors : In order to provide services and technical support for our products, the contracting entity within the ${APP_NAME} group engages other group entities and third parties .

Employees and independent contractors : We may provide access to your service data to our employees and individuals who are independent contractors of the ${APP_NAME} group entities involved in providing the services (collectively our “employees”) so that they can (i) identify, analyze and resolve errors, (ii) manually verify emails reported as spam to improve spam detection, or (iii) manually verify scanned images that you submit to us to verify the accuracy of optical character recognition. We ensure that access by our employees to your service data is restricted to specific individuals, and is logged and audited. Our employees will also have access to data that you knowingly share with us for technical support or to import data into our products or services. We communicate our privacy and security guidelines to our employees and strictly enforce privacy safeguards within the ${APP_NAME} group.
...
Our products and services are not directed to individuals under 16. ${APP_NAME} does not knowingly collect personal information from children who are under 16 years of age for its own purposes. If we become aware that a child under 16 has provided us with personal information, we will take steps to delete such information. If you believe that a child under 16 years has provided personal information to us, please write to ${CONTACT_EMAIL} with the details, and we will take the necessary steps to delete the information we hold about that child. However, using our products, you can collect information about individuals who may be children. If you process information relating to children, you acknowledge and agree that you will be responsible for complying with the applicable laws and regulations related to protection of such personal information.

How secure is your information
At ${APP_NAME}, we take data security very seriously. That's why we have gotten certified for industry standards mentioned here. We have taken steps to implement appropriate administrative, technical & physical safeguards to prevent unauthorized access, use, modification, disclosure or destruction of the information you entrust to us. If you have any concerns regarding the security of your data, we encourage you to check our Security Policy or write to us at security@${APP_NAME}corp.com with any questions.

Data Protection Officer
We have appointed a Data Protection Officer to oversee our management of your personal information in accordance with this Privacy Policy. If you have any questions or concerns about our privacy practices with respect to your personal information, you can reach out to our Data Protection Officer by sending an email to dpo@${APP_NAME}corp.com or by writing to: Data Protection Officer, ${APP_NAME} Corporation BV, Beneluxlaan 4B, 3527 HT Utrecht, The Netherlands.

Locations and international transfers
We share your personal information and service data within the ${APP_NAME} Group and with third parties engaged by ${APP_NAME} Group for the purposes described above. By accessing or using our products and services or otherwise providing personal information or service data to us, you understand that the processing, transfer, and storage of your personal information or Service Data within the United States of America, the European Economic Area (EEA) and other countries where ${APP_NAME} operates. Such transfers are subject to appropriate data protection agreements such as a group company agreement that is based on EU Commission’s Model Contractual Clauses for data processing activities to which GDPR applies. You can write to legal@${APP_NAME}corp.com for obtaining a copy of the agreements on the basis of which we transfer your data within ${APP_NAME} Group and with the third parties engaged by us.

Data processing addendum
To enable you to be compliant with your data protection obligations , we are prepared to sign an appropriate Data Processing Addendum (DPA). You can request a DPA from ${APP_NAME} by completing this form . Once we get your request, we'll forward the DPA to you for your signature.

Automation and Artificial Intelligence
In order to provide enhanced productivity and predictive capabilities to our users, we employ a variety of technologies such as regex parsing, template matching, artificial intelligence and machine learning. In keeping with ${APP_NAME}'s promise not to exploit your data in a way that is not respectful of your privacy and confidentiality expectations, we make only the following limited use of service data for these technologies: (i) using anonymized crops of service data to improve accuracy of the algorithms; and (ii) using your organization's data for developing models specific for your organization. Our automation and artificial intelligence technologies are mostly powered by our own organization's data such as internal communications, communications with customers and internal documents as well as free and paid external sources.
...
Blogs and forums
We offer publicly accessible blogs and forums on our websites. Please be aware that any information you provide on these blogs and forums may be used to contact you with unsolicited messages. We urge you to be cautious in disclosing personal information in our blogs and forums. ${APP_NAME} is not responsible for the personal information you elect to disclose publicly. Your posts and certain profile information may remain even after you terminate your account with ${APP_NAME}. To request the removal of your information from our blogs and forums, you can contact us at ${CONTACT_EMAIL}
