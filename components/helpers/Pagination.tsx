...
export default function Pagination({
	...
	return (
		<>
			<div
				className="w-full mt-16 mb-3"
				style={{ height: "0.5px", backgroundColor: "#7393B3" }}
			></div>
			<div className="w-full flex justify-start md:justify-end">
				...
				<div className="w-1/3 flex justify-end">
					<button
						type="button"
						className={
							currentPage > 1 ? "text-primary-600 hover:text-primary-900" : ""
						}
					...
					<span className="mx-2">
						<b>{currentPage}</b>/{getTotalPages} pages{" "}
					</span>
					<button
						type="button"
						className={
