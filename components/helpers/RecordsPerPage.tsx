import { FIRST_PAGE_NUMBER, RECORDS_PER_PAGE_OPTIONS, REPORTS_PER_PAGE_OPTIONS } from "@/lib/Constants"
...
export default function Pagination({ actualRecords, recordsPerPage, setRecordsPerPage }: RecordsPerPageProps) {
