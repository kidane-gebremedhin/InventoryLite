...
import { FREE_PLAN_LABEL, PAID_PLAN_DURATION, FREE_PLAN_DURATION } from '@/lib/Constants';
...
const tiers = [
  {
    ...
    paymentLink: '#',
    priceMonthly: 'Free',
    description: 'Get full access for a week just to get a feel of the application.',
    features: [
      'Single user',
      'Up to 50 items',
      'Reporting',
  ...
  },
  {
    name: 'Standard',
    id: 'tier-standard',
    priceId: process.env.NODE_ENV === 'development' ? 'price_1S8foNBi9Mbeb3tzh9fStzk3' : '',
    paymentLink: process.env.NODE_ENV === 'development' ? 'https://buy.stripe.com/test_3cI28qdtX0jkbZSaTFeIw00' : '',
    priceMonthly: '$9.99',
    description: 'Unlock powerful demand and inventory managment tools for your business.',
    features: [
      'Unlimited users',
      'Up to 500 items',
      'Reporting',
  ...
  },
  {
    name: 'Premium',
    id: 'tier-premium',
    priceId: process.env.NODE_ENV === 'development' ? 'price_1S8fvJBi9Mbeb3tziMSULl6X' : '',
    paymentLink: process.env.NODE_ENV === 'development' ? 'https://buy.stripe.com/test_8x29AS89D0jk1le2n9eIw01' : '',
    priceMonthly: '$29.99',
    description: 'For businesses that need a comprehensive demand and inventory management solution.',
    features: [
      'Unlimited users',
      'Unlimited Items',
      'Advanced reporting',
            ...
            {tiers.map((tier) => (
              ...
              >
                ...
                <div className="mt-4 flex items-baseline gap-x-2">
                  ...
                  <span className="text-base font-semibold leading-7 text-gray-600">/{tier.priceMonthly !== FREE_PLAN_LABEL ? PAID_PLAN_DURATION : FREE_PLAN_DURATION}</span>
                </div>
                <p className="mt-6 text-base leading-7 text-gray-600">{tier.description}</p>
                <ul role="list" className="mt-8 flex flex-col gap-y-3 text-sm leading-6 text-gray-600">
