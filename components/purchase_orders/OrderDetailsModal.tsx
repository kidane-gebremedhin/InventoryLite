...
import type { PurchaseOrder } from "@/lib/types/Models";
						...
						<div className="card">
							...
							<div className="space-y-2 text-sm">
								...
								<div>
									...
									<span
										className={`ml-2 px-2 py-1 text-xs font-semibold rounded-full ${getOrderStatusColor(order.status)}`}
									>
										{order.order_status}
									</span>
								</div>
								...
								<div>
									...
									<span className="ml-2">
										{formatDateToLocalDate(order.created_at)}
									</span>
								</div>
								<div>
									<span className="text-gray-600">Updated:</span>
									<span className="ml-2">
										{formatDateToLocalDate(order.updated_at)}
									</span>
								</div>
							</div>
						</div>
							...
							<div className="space-y-2 text-sm">
								<div>
									...
									<span className="ml-2 font-medium text-lg">
										{calculateOrderTotalProce(order.order_items)}
									</span>
								</div>
								<div>
