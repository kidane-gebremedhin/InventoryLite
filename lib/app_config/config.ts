...
export const APP_DESCRIPTION = 'A comprehensive demand tracking and inventory management system for businesses of all sizes. Perfect for Rtailers, Super Markets, and Shops';
